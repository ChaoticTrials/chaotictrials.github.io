...
## What went wrong?
When updating to Minecraft 1.21.1, I made the first mistake. For the [centered biomes feature](/docs/wiki/skyblock-builder/packdev/configs/dimensions#centered-biomes), I need a custom biome
