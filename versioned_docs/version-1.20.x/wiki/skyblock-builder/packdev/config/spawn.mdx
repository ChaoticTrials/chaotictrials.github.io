...
The solid block can be a normal block, a slab, or any block included in the [valid spawn block tag 🔗](https://minecraft.wiki/w/Tutorials/Creating_a_data_pack#Tags) `#skyblockbuilder:additional_valid_spawns`.
