...
<ProjectHeader slug="botanical-machinery" mcVersion="1.20" />
...
- Recipe machines automatically push finished items into adjacent inventories (see [Configuration](#configuration))
:::
...
|---------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------|
| `autoExportAllowed` | A [ResourceList](https://moddingx.github.io/LibX/org/moddingx/libx/util/data/ResourceList.html) controlling which adjacent blocks recipe machines may push output items into. | `ae2:pattern_provider`, `ae2:cable_bus` |
