...
You can turn this off in the config file.
...
If Quark is installed and the double door feature is enabled, this feature will work regardless of the UtilitiX
settings.

## Per Player Wandering Trader
The game will summon a Wandering Trader for every player, not just a random one.
