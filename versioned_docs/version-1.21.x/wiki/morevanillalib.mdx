...
<ProjectHeader slug="morevanillalib" mcVersion="1.21" />
...
## Tooltips
When pressing Shift while hovering over an item, it will reveal more details about durability, and repair items.
